...
2021-02-08 (1.15.0)
  ...
  * Fix the Errors structure difference for message key name in TransactionCanceledException
...
2020-10-13 (1.13.5)
  ...
  * Align Errors message with Amazon DynamoDB service for empty sets attributes, empty value attributes, and when invalid BETWEEN condition operator range is given
...
2020-09-14 (1.13.4)
  ...
  * Fixes an issue where the “begins_with” conditional function was not working correctly with DynamoDBBinary types for Java versions 9 and later.
...
2020-05-29 (1.13.1)
  ...
  * Bugfix to throw validation Errors when gsi is queried with non projected attribute
  * Bugfix to throw validation Errors when gsi with projection type other than ALL is queried with option Select as ALL_ATTRIBUTES

2020-05-20 (1.13.0)

  * Support up to 25 unique items and 4 MB of Data per TransactWriteItems and TransactGetItems request
  * Support empty values for non-key String and DynamoDBBinary attributes
  * Fix warning log messages when DB is reinitialized
  * Fix Errors messaging for inconsistent type validations
